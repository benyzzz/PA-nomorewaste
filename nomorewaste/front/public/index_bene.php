  ...
  <div class="container">
    ...
    <header>
        ...
        ?>
          ...
          <a href="benev/deposer_panier.php" class="CTA" data-translate="btnRecupererPaniers2">Déposer un panier !</a>
          <a href="benev/dashboard_benevole.php" class="CTA" data-translate="btnRecupererPaniers2">Livrer un panier</a>
        </div>
        <div class="colimg">
